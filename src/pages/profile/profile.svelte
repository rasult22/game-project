...
<div class="w-full flex gap-4 mt-[110px] rounded-[12px]">
  <div class="bg-[#2A2A2A] relative w-full flex-wrap justify-center flex flex-col items-center p-6 rounded-[20px] space-y-3">
    <div class="rounded-full w-[120px] h-[120px] border-4 border-orange-400">
      <img class="w-full" width="120" height="120" src="/avatar.png" alt="">
    </div>
    <!-- auth type -->
    ...
    {#if edit}
      ...
      <div transition:fade class="absolute p-2 text-black space-y-6 flex flex-col justify-center items-start right-0 -top-3 rounded-[20px] w-[50%] h-full bg-white">
        <div class="flex  items-center space-x-2">
          <img src="/edit-icon-black.svg" alt="">
