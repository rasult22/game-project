...
<div class="p-[20px] border border-[#888] rounded-[20px] mt-4">
    ...
    <div class="p-[14px] bg-[#2A2A2A] rounded-[16px] overflow-hidden">
      ...
      <div class="ml-[-5px]">
        <Chart
          ...
          string="$4.9M"
          data={[
            20, 24, 32, 22, 101, 120, 90, -250, -24, -32, -22, -101, -120, -90,
            -400,
          ]}
        />
        <!-- <Chart direction="negative" data={[-24,-32,-22,101,-120,-90,150, 24,32,22,-101,-120,-90, -200, 0]} /> -->
  ...
  <div class="mt-6">
    ...
    <div class="flex gap-4 mt-3">
      <!-- Volume 24h -->
      <div class="p-[14px] w-[50%] bg-[#2A2A2A] rounded-[16px] overflow-hidden">
        <!-- head -->
        <div class="flex justify-between">
          <div class="font-semibold">Volume 24h</div>
...
>
  ...
  <!-- cards -->
  <div class="flex gap-4 mt-6">
    <div class="bg-[#2A2A2A] min-w-[170px] text-white opacity-90 rounded-[16px] p-[14px]">
