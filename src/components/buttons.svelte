<!-- request btn -->
<button class="font-medium border py-3 active:border-[#fff] active:scale-95 transition-all px-[36px] rounded-[12px]">Send request</button>
<!-- login btn -->
<button class="font-medium bg-[#fff] text-black border py-3 active:border-[#fff] active:scale-95 active:bg-[#D9D9D9] transition-all px-[36px] rounded-[12px]">Log in</button>
<!-- play btn -->
<button class="font-medium bg-[#fff] flex items-center space-x-2 text-black border py-2 active:border-[#fff] active:scale-95 active:bg-[#D9D9D9] transition-all px-[36px] rounded-[12px]">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M7 4V20L20 12L7 4Z" stroke="#2A2A2A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  <span>
    Play
  </span>
...
<!-- play active btn -->
<button class="font-medium bg-[#1CC141] flex items-center space-x-2 text-white py-2 active:scale-95 active:bg-[#17B23A] transition-all px-[36px] rounded-[12px]">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<!-- follow btn -->
<button class="font-medium bg-[#272727] flex items-center space-x-2 text-white py-[10px] active:scale-95 active:bg-[#272727] transition-all px-[36px] rounded-[12px]">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<!-- sign in button -->
<button class="font-medium bg-[#fff] flex items-center space-x-2 text-black border py-3 active:border-[#fff] active:scale-95 active:bg-[#D9D9D9] transition-all px-[36px] rounded-[12px]">
  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.16813 9.80931L18 17.6972L29.8319 9.80931C29.582 9.32845 29.0794 9 28.5 9H7.5C6.92064 9 6.418 9.32845 6.16813 9.80931ZM30 13.3028L18.8321 20.7481C18.3282 21.084 17.6718 21.084 17.1679 20.7481L6 13.3028V25.5C6 26.3284 6.67157 27 7.5 27H28.5C29.3284 27 30 26.3284 30 25.5V13.3028ZM3 10.5C3 8.01472 5.01472 6 7.5 6H28.5C30.9853 6 33 8.01472 33 10.5V25.5C33 27.9853 30.9853 30 28.5 30H7.5C5.01472 30 3 27.9853 3 25.5V10.5Z" fill="#141517"/>
  </svg>
  <span>
    Sign Up with email
  </span>
...
<button class="bg-[#464648] active:scale-95 active:bg-[#58585B] transition-all rounded-[24px] px-4 py-[10px] flex items-center">
  <img src="/game-project/media/metamask-icon.png" width="48" height="48" alt="">
  <div class="ml-4 font-medium">
    Metamask
  </div>
</button>
<button class="bg-[#464648] active:scale-95 active:bg-[#58585B] transition-all rounded-[24px] px-4 py-[10px] flex items-center">
  <img src="/game-project/media/trustwallet-icon.png" width="48" height="48" alt="">
  <div class="ml-4 font-medium">
    TrustWallet
  </div>
</button>
