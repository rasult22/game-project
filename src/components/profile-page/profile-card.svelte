...
<div class="bg-[#1C1C1E] relative w-full flex-wrap justify-center flex flex-col items-center p-6 rounded-[20px] space-y-3">
  ...
  <div class="flex items-center space-x-2">
    ...
    <img on:click={() => edit = true} class="active:scale-95 active:opacity-60 transition-all cursor-pointer" width="24" height="24" src="/game-project/media/edit-icon.svg" alt="">
  </div>
  <div class="flex items-center space-x-2">
